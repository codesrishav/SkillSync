  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 glass-card p-10 relative overflow-hidden">
        {/* Decorative blobs */}
        <div className="absolute -top-10 -right-10 w-32 h-32 bg-brand-200 rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-blob"></div>
        <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-accent-light rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-blob animation-delay-2000"></div>
        ...
        <div className="text-center relative z-10">
          ...
          <p className="mt-2 text-sm font-medium text-gray-500">
            ...
            <Link to="/signup" className="text-brand-600 hover:text-brand-500 underline decoration-brand-300 underline-offset-4 transition-colors">
              Sign up
            </Link>
          </p>
        </div>
